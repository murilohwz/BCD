...
SELECT AVG(Salario) AS "Media Salarial dos Desenvolvedores"
FROM Funcionarios
WHERE Funcao = 'Desenvolvedor' OR Salario > 4200;

-- 12. Selecione o número de funcionários que têm "Almeida" como parte do nome do Funcionario OU têm salário inferior a 3500.
SELECT COUNT(*) AS "Numero de Funcionarios"
FROM Funcionarios
WHERE SegundoNome = 'Almeida' OR UltimoNome = 'Almeida' OR Salario < 3500;
...
SELECT COUNT(*) AS "Numero de Funcionarios"
FROM Funcionarios
WHERE Salario = 3600 OR Endereco = 'Curitiba';