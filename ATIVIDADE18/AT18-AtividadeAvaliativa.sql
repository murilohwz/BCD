...
/*01)  Selecione a distância principal e o número de corredores que correram a distância determinada (numero_corredores). 
Exiba somente as linhas em que o número de corredores for maior que 3.*/
	select tb_corredor.metros_distancia as distancia_principal;
    
    

/*02) Exiba o nome do evento e o número de membros do clube que participam desse evento (chame essa coluna de runner_count). 
Observe que pode haver eventos em que nenhum associado do clube participe. Para esses eventos, o runner_count deve ser igual a 0.*/
	select count(runner_count) is null = 0;
    

/*03)  Listar o corredor mais ativo (aquele que participou do maior número de eventos) e a quantidade de eventos que ele participou.
	select table tb_corredor_evento 
    EVENTO_id_evento > 4;
