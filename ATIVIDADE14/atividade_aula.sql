...
select nome_cliente, data nascimento
from tb_clientes
...
select * from vw_aniversariante_mes_mes2
...
SELECT nome_cliente, telefone_cliente, data_nascimento, YEAR(data_nascimento) AS ano_nascimento
FROM tb_cliente;
