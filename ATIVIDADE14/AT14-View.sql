...
create view vw_clientes_nascimento as select nome_cliente,
...
create view vw_produtos_precos as select nome_produto, preco_venda, preco_compra,
preco_venda - preco_compra as lucro from tb_produto;
...
select * from vw_cliente_detalhes where cidade = 'São Paulo';
...
select nome_produto, categoria from vw_produtos_estoque where estoque > 150;


-- 8. Usando a view "vw_clientes_nascimento", selecione o nome dos clientes nascidos no mês de fevereiro.
select nome_cliente, mes_nascimento
...
select lucro from vw_produtos_precos where lucro = 5.00;


-- 10. Usando a view "vw_categorias", selecione as categorias com mais de 10 produtos cadastrados.
select categoria, produto_categoria from vw_categorias where produto_categoria > 10;
